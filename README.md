# 免去繁杂手动设置，点击进入 → → → [Clash(yaml)规则文件一键生成器](https://github.com/Ozero-top/OpenClash-Online-YAML-Generator) 
# 喜欢折腾的可以下载配置文件 手动设置。
## ✨ 功能特性
...
### 3️⃣ Clash-Cloud.yaml运行配置文件保留了丰富的业务分流组：<br>
  ...
  #### 增加国内主流银行、支付、政务及风控系统的Fake-IP过滤与强制直连规则，解决App风控误连海外问题<br>
  #### 排除无效节点（如流量提示、过期通知、剩余流量 等占位节点）的过滤机制<br>
...
### 此套配置文件因开启运行模式为 TUN ，虽然做了优化但同样会有性能消耗
